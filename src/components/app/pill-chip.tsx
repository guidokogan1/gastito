...
export function PillChip({
  ...
  return (
    <span
      className={cn(
        "inline-flex h-10 shrink-0 items-center gap-2 rounded-full border border-transparent bg-[var(--surface-pill)] px-3.5 text-[0.92rem] font-normal text-foreground transition-colors hover:bg-[var(--surface-selected)]",
